...
アプリ起動後のメインメニューから、ログインせずCPU戦へ進み、以下を設定できます。
...
AndroidのCPU戦はAPK内の共通Javaゲームコアを直接実行するため、サーバー接続なしでも2〜8人戦を検証できます。
...
- マルチプレイ: 2〜8人
- オフラインCPU戦: 人間1 + CPU1〜7人
- ロビーは8席表示
- 相手最大7人は横スクロール表示
- CPU人数選択も横スクロール化し、小画面でのレイアウト崩れを回避
- CPUカードモーションの開始位置を最大7人に対応
